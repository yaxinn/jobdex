...
class TestDocument(unittest.TestCase):
    ...
    def testRemoveDocumentNonexistentID(self):
        ...
        """
        self.assertEqual(0, self.documents.remove_document("NONEXISTENT_DOCUMENT_ID"))
    ...
    def testGetDocumentsNonexistentUser(self):
        ...
        """
        self.assertEqual(0, self.documents.get_documents("NONEXISTENT_USER_ID"))
    ...
    def testGetDocumentsLongUsername(self):
        ...
        self.assertEqual(0, self.documents.get_documents(long_user_id))
