...
class TestUser(unittest.TestCase):
    ...
    def testSignUp(self):
        ...
        """
        self.assertEqual(1, self.users.sign_up("userA", "myPassword", "myPassword", "userA@gmail.com"))
    ...
    def testSignUpEmptyUsername(self):
        ...
        """
        self.assertEqual(0, self.users.sign_up("", "myPassword", "myPassword", "userA@gmail.com"))

    def testSignUpNoneUsername(self):
        """
        Test that signing up with a None object as the username fails.
        """
        self.assertEqual(0, self.users.sign_up(None, "myPassword", "myPassword", "userA@gmail.com"))
    ...
    def testSignUpLongUsername(self):
        ...
        self.assertEqual(0, self.users.sign_up(None, long_username, long_username, "userA@gmail.com"))

    def testSignUpEmptyPassword(self):
        """
        Test that signing up with an empty password fails.
        """
        self.assertEqual(0, self.users.sign_up("userB", "", "", "userB@gmail.com"))

    def testSignUpNonePassword(self):
        """
        Test that signing up with None as the password fails.
        """
        self.assertEqual(0, self.users.sign_up("userC", None, None, "userC@gmail.com"))
    ...
    def testSignUpLongPassword(self):
        ...
        self.assertEqual(0, self.users.sign_up("userD", long_password, long_password, "userD@gmail.com"))
    ...
    def testSignUpUnmatchingPasswords(self):
        ...
        """
        self.assertEqual(0, self.users.sign_up("userE", "ilovebears", "ihatebears", "userE@gmail.com"))

    def testSignUpInvalidEmail1(self):
        """
        Test that signing up with an invalid email address format (i.e. missing @ symbol) fails.
        """
        self.assertEqual(0, self.users.sign_up("userF", "myPassword", "myPassword", "userFgmail.com"))

    def testSignUpInvalidEmail2(self):
        """
        Test that signing up with an invalid email address format (i.e. missing a period) fails.
        """
        self.assertEqual(0, self.users.sign_up("userG", "myPassword", "myPassword", "userG@gmailcom"))
    ...
    def testSignUpInvalidEmail3(self):
        ...
        """
        self.assertEquals(0, self.users.sign_up("userH", "myPassword", "myPassword", "blahblahblah"))

    def testSignUpEmptyEmail(self):
        """
        Test that signing up with an empty email address fails.
        """
        self.assertEqual(0, self.users.sign_up("userI", "myPassword", "myPassword", ""))

    def testSignUpNoneEmail(self):
        """
        Test that signing up with email address as None fails.
        """
        self.assertEqual(0, self.users.sign_up("userJ", "myPassword", "myPassword", None))

    def testSignUpUserExists(self):
        """
        Tests that signing up with a username that already exists in the database fails.
        """
        self.assertEqual(1, self.users.sign_up("userK", "myPassword", "myPassword", "userK@gmail.com"))
        self.assertEqual(0, self.users.sign_up("userK", "myPassword", "myPassword", "userK@gmail.com"))

    def testSignUpConsecutively(self):
        """
        Tests that signing up two users consecutively works.
        """
        self.assertEqual(1, self.users.sign_up("userL", "myPassword", "myPassword", "userL@gmail.com"))
        self.assertEqual(1, self.users.sign_up("userM", "myPassword", "myPassword", "userM@gmail.com"))

    def testSignUpNoneUsernameAndPassword(self):
        """
        Tests that signing up with both username AND password as None fails
        """
        self.assertEqual(0, self.users.sign_up(None, None, None, "both_none@gmail.com"))

    def testSignUpBlankUsernameAndPassword(self):
        """
        Tests that signing up with both a blank username AND password fails
        """
        self.assertEqual(0, self.users.sign_up("", "", "", "both_blank@gmail.com"))
    ...
    def testSignUpLongUsernameAndPassword(self):
        ...
        long_password = original_password*10
        self.assertEqual(0, self.users.sign_up(long_username, long_password, long_password,
                                                            "both_long@gmail.com"))
    ...
    def testLogin(self):
        ...
        """
        self.assertEqual(1, self.users.sign_up("userN", "myPassword", "myPassword", "userN@gmail.com"))
        self.assertEqual(1, self.users.login("userN", "myPassword"))

    def testLoginUserNonExistent(self):
        """
        Tests that user login fails with a username that doesn't exist in the database.
        """
        self.assertEqual(0, self.users.login("this_user_doesnt_exist", "myPassword"))
    ...
    def testLoginBadPassword(self):
        ...
        """
        self.assertEqual(1, self.users.sign_up("userO", "password", "password", "userO@gmail.com"))
        self.assertEqual(0, self.users.login("userO", "passw0rd"))

    def testLoginEmptyUsername(self):
        """
        Tests that user login fails with an empty username.
        """
        self.assertEqual(0, self.users.login("", "password"))

    def testLoginEmptyPassword(self):
        """
        Tests that user login fails with an empty password.
        """
        self.assertEqual(1, self.users.sign_up("userP", "password", "password", "userP@gmail.com"))
        self.assertEqual(0, self.users.login("userP", ""))

    def testLoginNoneUsername(self):
        """
        Tests that user login fails with a None username.
        """
        self.assertEqual(0, self.users.login(None, "password"))

    def testLoginNonePassword(self):
        """
        Tests that user login fails with a None password.
        """
        self.assertEqual(1, self.users.sign_up("userQ", "password", "password", "userQ@gmail.com"))
        self.assertEqual(0, self.users.login("userQ", None))
    ...
    def testLoginLongUsername(self):
        ...
        original_username = "this_will_be_long"
        long_username = original_username*10
        self.assertEqual(0, self.users.login(long_username, "password"))
    ...
    def testLoginLongPassword(self):
        ...
        original_password = "this_will_be_long"
        long_password = original_password*10
        self.assertEqual(0, self.users.login("userR", long_password))
    ...
    def testLogout(self):
        ...
        """
        self.assertEqual(1, self.users.sign_up("paulina", "myPassword", "myPassword", "paulina@gmail.com"))
        self.assertEqual(1, self.users.login("paulina", "myPassword"))
        self.assertEqual(1, self.users.logout())
